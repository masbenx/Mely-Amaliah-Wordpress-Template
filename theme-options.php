...
function mytheme_add_admin() {
	...
	add_theme_page("Theme Option", "Theme Option", 'administrator', basename(__FILE__), 'mytheme_admin');
}
			...
			?>
 			...
 			?>
 						<div class="rm_section">
 							<div class="rm_title">
 								<h3><img src="<?php echo get_template_directory_uri();?>/images/masbenx2.png" class="inactive" alt="""><?php echo $value['name']; ?></h3>
